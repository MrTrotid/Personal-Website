        ...
        <div className="space-y-8 backdrop-blur-sm bg-black/30 p-8 rounded-lg mt-8 
          ...
          <section className="space-y-4">
            <p className="text-lg text-gray-200 animate-fadeIn delay-300 
              ...
              Hi, I am a enthusiastic learner who wants a career in Ethical Hacking in the coming future. Currently I am a learner who is hungry to gain more knowledge with having intermediate knowledge in the field.
            </p>
